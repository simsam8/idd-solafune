...
def compute_f1_score(pred_mask, truth_mask):
    ...
    # converting nympy array to pytorch tensor
    pred_mask = torch.tensor(pred_mask, dtype=torch.float32)  # Ensure it's float32
    pred_mask = F.interpolate(pred_mask.unsqueeze(0).unsqueeze(0), size=(1024, 1024), mode="nearest")
